...
contract ForkTest is Test {
   ...
   // Setting staleness threshold = 2 hours (real data is updated every ~1 hour)
    ...
    function test_Fork_ChainlinkStaleness_SimulatedOldData() public {
        ...
        assertFalse(vault.isPriceFresh(), "Price should be stale after time warp");
        ...
        console2.log("Fork staleness test passed: deposit correctly reverted with stale price");
    }
}
